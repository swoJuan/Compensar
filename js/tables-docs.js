...
.mp-table, .table.mp-table { --mp-table-bg:var(--use-surface-white); --mp-table-head-bg:var(--use-surface-white); --mp-table-bg-alt:var(--use-tables-stripes); --mp-table-bg-hover:var(--use-tables-filter); --mp-table-bg-selected:var(--use-surface-orange); --mp-table-border:var(--use-border-subtle); --mp-table-text:var(--use-text-primary); --mp-table-muted:var(--use-text-secondary); --mp-table-accent:var(--use-primary-default); width:100%; min-width:40rem; margin:0; border-collapse:separate; border-spacing:0; color:var(--mp-table-text); background:var(--mp-table-bg); font-family:var(--font-body); font-size:var(--font-size-md); line-height:1.3; vertical-align:middle; }
